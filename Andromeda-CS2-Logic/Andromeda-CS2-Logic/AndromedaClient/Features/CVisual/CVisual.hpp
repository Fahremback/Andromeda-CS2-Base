...
private:
	// Throttle CalculateBoundingBoxes to avoid running every view matrix update
	uint32_t m_bboxUpdateCounter = 0;
	static constexpr uint32_t BBOX_UPDATE_INTERVAL = 4; // Every 4 frames
