...
void CPhysicsCriticalPhases::Phase4::Inertial_Damping_Override(Vector3& ioVelocity, float dampingFactor)
{
    const __m128 velocity = _mm_set_ps(0.0f, ioVelocity.m_z, ioVelocity.m_y, ioVelocity.m_x);
    const __m128 damping = _mm_set1_ps((std::clamp)(dampingFactor, 0.0f, 1.0f));
